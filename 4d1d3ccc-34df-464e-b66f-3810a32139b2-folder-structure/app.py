...
from authentication.controllers.role_controller import role_controller
...
app.register_blueprint(role_controller, url_prefix='/dashboard')
...
# File 7: Schema Definition for Roles Table in database/20_create_roles_table.sql