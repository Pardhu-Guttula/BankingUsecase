...
class IncompleteApplicationRepository:
    ...
    @staticmethod
    def get_application_by_user_id(user_id: int) -> IncompleteApplication:
...
# File 3: Incomplete Application Service for Business Logic in dashboard/services/incomplete_application_service.py